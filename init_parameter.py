...
def init_model():
    ...
    parser.add_argument("--save_premodel", action="store_true", help="Save the pretrained model.")

    parser.add_argument("--save_premodel_path", default="./premodel", type=str,
                        help="Path to save the pretrained model checkpoints.")
    ...
    parser.add_argument("--m", default=5, type=int, help="The dimension for rank statistic constraint.")

    parser.add_argument("--temperature", default=0.07, type=float, help="The temperature for contrastive learning.")

    parser.add_argument("--alpha", default=0.99, type=float, help="The weighting factor for momentum negative key with different coarse labels as the query.")
    ...
    parser.add_argument("--topk", default=120, type=int,
